...
import ProductCardGrid from "@/components/product-card/ProductCardGrid/ProductCardGrid";
import ProductCardList from "@/components/product-card/ProductCardList/ProductCardList";
    ...
    <div className="catalog__inner">
      ...
      <div className={viewType === "grid" ? "catalog__grid" : "catalog__list"}>
        {products.map((product) =>
          viewType === "grid" ? (
            <ProductCardGrid
              key={`catalogGrid-${product._id}`}
              product={product}
            />
          ) : (
            <ProductCardList
              key={`catalogList-${product._id}`}
              product={product}
            />
          )
        )}
